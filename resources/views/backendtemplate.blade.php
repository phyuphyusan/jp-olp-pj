...
<head>
  ...
  <link href="{{ url('backendtemplate/css/sb-admin-2.min.css')}}" rel="stylesheet">
  <!-- <link href="{{ asset('backendtemplate/js/jQuery.js')}}" rel="stylesheet"> -->
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">OLP Admin <sup>2</sup></div>
      </a>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-primary" href="{{route('homepage')}}">Logout</a>
        </div>
      </div>
    </div>
  </div>
